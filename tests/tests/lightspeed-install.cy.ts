...
`),
  ...
  it('Test attach cluster info for ManagedCluster', () => {
    ...
    cy.visit('/k8s/ns/test-cluster/cluster.open-cluster-management.io~v1~ManagedCluster/test-cluster');
    cy.get(mainButton).click();
    cy.get(popover).should('exist');
    ...
    cy.intercept('GET', '/api/kubernetes/apis/cluster.open-cluster-management.io/v1/managedclusters/test-cluster', {
      statusCode: 200,
      body: {
        kind: 'ManagedCluster',
    ...
    cy.intercept('GET', '/api/kubernetes/apis/internal.open-cluster-management.io/v1beta1/namespaces/test-cluster/managedclusterinfos/test-cluster', {
      statusCode: 200,
      body: {
  ...
  it('Test ManagedCluster attachment error handling', () => {
    ...
    cy.intercept('GET', '/api/kubernetes/apis/internal.open-cluster-management.io/v1beta1/namespaces/test-cluster/managedclusterinfos/test-cluster', {
      ...
      body: {
        kind: 'Status',
        message: 'managedclusterinfos.internal.open-cluster-management.io "test-cluster" not found'
      }
