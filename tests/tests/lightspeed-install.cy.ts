...
const clearChatButton = '[data-test-id="ols-plugin__clear-chat-button"]';
...
const copyConversationButton = '[data-test-id="ols-plugin__copy-conversation-button"]';
const copyConversationTooltip = '[data-test-id="ols-plugin__copy-conversation-tooltip"]';
